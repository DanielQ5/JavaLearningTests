...
1.Data Structure: Use a HashMap to store employee records (employeeID as the key and an Employee object as the value).

Implementation Details:
1.Create an Employee class with name, and department attributes.
...
public class EmployeeDataBaseMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nThis is the Main Data Base for Employee management, where you can find EE Information such as: ID, Name & Department");
        ...
        while (isListFinished) {
            try {
                ...
                System.out.println("\nWould you like to add another Employee? (Type: 1 for Yes , Type: 99 for No)");
                int continueInsertingEEs = scanner.nextInt();

                if (continueInsertingEEs == finalizeList) {
                    isListFinished = false;
                    System.out.println("\nThe Employee list is as follow: ");
        ...
        System.out.println("1. I want to add a new Employee to the database.");
        System.out.println("2. I want to search for an Employee in the database.");
        System.out.println("3. I want to update an Employee's department in the database.");
        System.out.println("4. I want to delete an Employee from the database.");
        ...
        while (continueLoop) {
            try {
                ...
                switch (menuOption) {
                    ...
                    case 1: //Add new Employee to the DataBase
                        ...
                        while (isListFinished1) {
                            try {
                                ...
                                if (keyAddedToMap == null) {
                                    System.out.println("The new Employee was successfully added.");
                                    System.out.println(employeeListDataBase);
                                } else {
                    ...
                    case 2://Search for an Employee.
                        ...
                        showMenu();
                        break;
                    case 3: //Update an Employee's department in the database.2
                        System.out.println("Please enter the Employee ID of the person you want to update the Department for:");
                        ...
                        if (searchForEmployee == null) {
                            System.out.println("The Employee ID that you have provided, does not exist in the DataBase.");
                            showMenu();
                        } else {
                        ...
                        break;
                    case 4: //Delete an Employee's information from the Data Base
                        System.out.println("Please enter the Employee ID of the person you want to delete from the Data Base:");
